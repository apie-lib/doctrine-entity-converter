...
trait HasGeneralDoctrineFields
{
    ...
    #[Column(name: 'created_at', type: 'decimal', precision: 21, scale: 6)]
    public string $createdAt;

    #[Column(name: 'updated_at', type: 'decimal', precision: 21, scale: 6)]
    ...
    public function onPrePersist(): void
    {
        ...
        $this->createdAt = ApieLib::getPsrClock()->now()->format('U.u');
    ...
    {
        // time is stored as decimal because not all datetime formats support microseconds on db platforms.
        $this->updatedAt = ApieLib::getPsrClock()->now()->format('U.u');
